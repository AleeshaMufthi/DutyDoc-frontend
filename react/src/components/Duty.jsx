...
const Duty = () => {
  ...
  return (
    <div className='border border-gray-200 p-5 rounded-2xl mt-5'>
             <div className="flex items-center justify-between mb-4">
        <h2 className="text-xl font-semibold text-gray-800">Dutys</h2>
        <button className="text-blue-600 hover:text-blue-700 font-medium">View all</button>
      </div>
      <div className="flex space-x-6 text-gray-800 font-semibold mb-3">
  <h2>Applied (20)</h2>
  <h2>Waiting (19)</h2>
  <h2>Rejected (22)</h2>
</div>
